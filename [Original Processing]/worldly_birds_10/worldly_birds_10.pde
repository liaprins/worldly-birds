...
//  /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
    ...
    if(hover_swallow_button == true && alpha_test == alpha_on){
    ...
    if (hover_swallow_button == true && alpha_test == alpha_off){
...
//  ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ */
    ...
    for(int sighting = 0; sighting<birds.size(); ++sighting){ 
      ...
      if((counter>=date_projection - sighting_duration && 
        ...
        if((swallow_color_code.equals(birds.get(sighting).species) && alpha_test == alpha_on) || (swallow_color_code.equals(birds.get(sighting).species) && hover_swallow_button == true)){
          //  fill(swallow_color);
          stroke(swallow_stroke);
