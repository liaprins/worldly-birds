...
public class worldly_birds_23 extends PApplet {
...
public void draw() { 
  ...
  if (millis() > starttime+1000*millis_multiplier) { 
    ...
    if (hover_macaw_button == true && macaw_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 14)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + macaw_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 14)  
    ...
    if (hover_vireo_button == true && vireo_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 15)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + vireo_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 15)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_bee_button == true && bee_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 16)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + bee_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 16)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_kingfisher_button == true && kingfisher_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 17)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + kingfisher_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 17)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_pintail_button == true && pintail_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 18)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + pintail_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 18)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_swallow_button == true && swallow_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 19)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + swallow_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 19)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_shearwater_button == true && shearwater_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 20)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + shearwater_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 20)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_kite_button == true && kite_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 21)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + kite_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 21)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_penguin_button == true && penguin_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 22)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + penguin_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 22)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_swift_button == true && swift_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 23)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + swift_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 23)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_martin_button == true && martin_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 24)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + martin_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 24)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
    ...
    if (hover_galah_button == true && galah_dot_alpha == alpha_on) {      
      ...
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 25)  
        + button_wall_offset   - (button_width + (hummingbird_img.width*scale + galah_line_edit)- line_diameter*.5f), 
      height - button_vertical_offset - (button_width*.5f) - line_height - line_diameter*.5f);
      image(hummingbird_img, 
      ((width - 2*button_wall_offset) / 24)*(-1 + 25)  
        + button_wall_offset - (hummingbird_img.width*scale + img_horizontal_offset), 
...
//  ^H
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "worldly_birds_23" };
    if (passedArgs != null) {
