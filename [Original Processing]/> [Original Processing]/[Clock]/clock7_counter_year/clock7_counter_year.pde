...
//In combination with /* & */ //  these encapsulate temporarily commented out sections for experimenting.
//  ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ 
...
void draw(){  
  ...
  if(millis() > starttime+1.5*100){ 
    ...
    */
    ...
    fill(255,255,0);
    text(dates.get(counter).month,  20,20);
    text(dates.get(counter).day,  150,20);
