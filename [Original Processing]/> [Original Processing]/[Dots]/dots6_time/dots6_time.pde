/*
Dots to show up on command according to the "date" (a.k.a. number coordinated to timer) in their own external file

PROBLEM: Right now it is running out of memory after some cycles through....
*/
...
//  %%%%TEST%%%%  /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
...
void setup(){
  ...
  birds = new ArrayList<Birds>();
    try {  
      ...
      BufferedReader reader = createReader("22_penguin.csv");
      String line = ",";
...
//  %%%%TEST%%%%      background(255,255,255);
    ...
    */
    ...
    for(int sighting = 0; sighting<birds.size(); ++sighting){ 
      ...
      //  If the value of the counter matches the date in the Excel sheet, make a dot as specified by that line in the Excel sheet
