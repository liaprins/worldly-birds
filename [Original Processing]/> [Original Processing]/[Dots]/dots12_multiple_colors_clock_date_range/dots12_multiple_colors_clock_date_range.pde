...
float millis_multiplier = .005;  //  controls the speed of the counter; .15 ~= 60s/cycle, smaller number = faster
int sighting_duration = 10;  //  ('0'=just its date) the date range for which a dot shows up; e.g. '10' means a dot show up 10 days ahead of when its date matches the counter value, and stays 10 days after
...
int clockArm = 210;  //  clock radius in pixels
...
//  (?)  don't delete
PVector handle_vector;

//................................................................

//  dots
float dot_size = 4;
//  %%%% TEST %%%%  //  int dot_alpha = 100;
int dot_alpha;
...
void setup(){
  ...
  handle_vector = new PVector(0, clockArm); 
...
void draw(){ 
  ...
  if(millis() > starttime+1000*millis_multiplier){ 
    ...
    for(int sighting = 0; sighting<birds.size(); ++sighting){ 
      ...
      if((counter>=date_projection - sighting_duration && 
          ...
          //  trying to solve the Jan 1 "jump" effect... || caused Harlem shake Jan. 1-10; && caused regular activity Jan.1-10 when sighting_duration = 10
          //  %%%% BREAKING NEWS %%%%  Careful study reveals 'Jump' actually occurs Jan. 3...could just be the nature of the eBird data collectors?
          /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
          ||
            &&
          ((counter - counter_duration) + sighting_duration)<=sighting_duration &&
          counter<=sighting_duration
          ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ */ 


          //  trying to solve the Jan 1 "jump" effect...this did nothing 
          //  %%%% BREAKING NEWS %%%%  Careful study reveals 'Jump' actually occurs Jan. 3...could just be the nature of the eBird data collectors?       
          /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
          ||
  ...
  /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
    ...
    //  %%%%%% NOTE %%%%%%  to make it keep cycling after it gets to the top; problem solved by using ">=" (greater than OR EQUAL!) otherwise it hits an OutOfBoundsException error
    ...
    //rotation command
    rotate( counter * radians(.986) ); //.986=360degrees/365"days", so 1 rotation every 60seconds (almost, as close as can get)
    ...
    ellipse(handle_vector.x, -handle_vector.y, handleDiameter, handleDiameter);
    
    //clock edge is an arc with the part missing where the handle is, so the handle can be transparent without showing the clock radius through
    noFill();
    strokeWeight(clockStroke);
