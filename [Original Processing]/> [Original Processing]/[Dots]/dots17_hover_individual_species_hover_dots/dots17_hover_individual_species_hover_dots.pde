/*
Hover over button and sighting dots for swallow show up bigger.

PROBLEMS:

Can't get it to make the sighting dots bigger when I hover over them!
...
//  /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
    ...
    if(hover_swallow_button || hover_swallow_dot){
      ...
      if(hover_swallow_dot){
        println("swallow sighting dot");
      }
      
      } else {
        
        //  button hover; light red = OFF
        fill(255,125,125);
...
//  ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ */
    ...
    //  %%%% TESTING HOVER %%%% (after translate to center)
  /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
    //  [BUTTON FUNCTIONALITY] set fill based on mouse input
    if(hover){
  ...
  ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ */
    ...
    //  %%%% TESTING HOVER %%%%  when this is not commented out, this somehow cancels out button hover that makes dots bigger...
    /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
    //  [BUTTON FUNCTIONALITY] set fill based on mouse input
    if(hover_swallow_dot){
...
//     /* v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v-v
     ||
//     (
     x_dodo > x_position*map_lat - dot_size/2 &&
      x_dodo < x_position*map_lat + dot_size/2 &&
      y_dodo > y_position*map_lng - dot_size/2 &&
      y_dodo < y_position*map_lng + dot_size/2)
//     ^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^-^ */
      {
      return true;
...
//  not sure if it would have to change for each bird, or if it could stay the same for all, or even if it could be mouseX and mouseY?
boolean hover_swallow_dot( int x_dodo, int y_dodo){
  
  if(x_dodo > x_position*map_lat - dot_size/2 &&
     x_dodo < x_position*map_lat + dot_size/2 &&
     y_dodo > y_position*map_lng - dot_size/2 &&
     y_dodo < y_position*map_lng + dot_size/2){
      return true;
