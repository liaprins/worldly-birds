/*
PARENT FILE == buttons2

see also: 
http://www.processing.lyndondaniels.com/55buttonCla.shtml#classN

Currently no click state (?), but hover is fine.
1. Figure out how the heck boolean works.
2. Use it to make one clickable button with proper on/off states and perfect functionality (can ignore hover for now).
3. Use it to make two clickable buttons.
4. Figure out how to apply to array of buttons or similar (for effeciency).
