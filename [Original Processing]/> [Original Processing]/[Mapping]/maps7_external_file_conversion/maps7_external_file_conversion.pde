...
void setup(){
  ...
  crayons = new ArrayList<Crayon>();
    try {  
      ...
      BufferedReader reader = createReader("20_shearwater.csv");
      String line = ",";
      ...
      while((line = reader.readLine()) != null){
        ...
        crayons.add(new Crayon(entity[0], entity[1], entity[2], entity[3]));
...
float map_lng = -3.47;
  ...
  int columns = crayons.size();
    ...
    for(int i = 0; i<columns; ++i){ 
      ...
      //  array of dots
      ellipse(x_position*map_lat, y_position*map_lng,  3,3);
...
class Crayon{
  ...
  Crayon(String s1, String s2, String s3, String s4){ 
     x = s2;
     y = s3;
  }
}  //close the class
